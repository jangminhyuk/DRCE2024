...
def summarize(lqg_lambda_values, lqg_theta_v_values, lqg_cost_values ,wdrc_lambda_values, wdrc_theta_v_values, wdrc_cost_values , drce_lambda_values, drce_theta_v_values, drce_cost_values, dist, noise_dist, path):
    surfaces = []
    labels = []
    # Create 3D plot
    plt.rcParams.update({
...
if __name__ == "__main__":
    ...
    lambda_list = [6, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60]
    ...
    summarize(lqg_lambda_values, lqg_theta_v_values, lqg_cost_values ,wdrc_lambda_values, wdrc_theta_v_values, wdrc_cost_values , drce_lambda_values, drce_theta_v_values, drce_cost_values, args.dist, args.noise_dist, path)
