...
def summarize_noise(num_noise_list, avg_cost_lqg, std_cost_lqg, avg_cost_wdrc, std_cost_wdrc, avg_cost_drce, std_cost_drce, avg_cost_drlqc, std_cost_drlqc, dist, noise_dist, infinite, path):
...
if __name__ == "__main__":
    ...
    print("avg_cost_drlqc : ",avg_cost_drlqc)
    ...
    summarize_noise(num_noise_list, avg_cost_lqg, std_cost_lqg, avg_cost_wdrc, std_cost_wdrc, avg_cost_drce, std_cost_drce, avg_cost_drlqc, std_cost_drlqc, args.dist, args.noise_dist, args.infinite ,path)
