...
def summarize(out_lq_list, out_wdrc_list, out_drce_list, out_drlqc_list, dist, noise_dist, path, num, infinite, plot_results=True):
...
if __name__ == "__main__":
    ...
    summarize(lqg_data, wdrc_data, drce_data, drlqc_data, args.dist, args.noise_dist, path, args.num_sim, args.infinite , plot_results=True)
