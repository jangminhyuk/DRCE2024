...
def main(dist, noise_dist1, num_sim, num_samples, num_noise_samples, T,infinite, plot_results):
    ...
    output_J_LQG_mean, output_J_WDRC_mean, output_J_DRCE_mean, output_J_DRCMMSE_mean, output_J_DRLQC_mean =[], [], [], [], []
    output_J_LQG_std, output_J_WDRC_std, output_J_DRCE_std, output_J_DRCMMSE_std, output_J_DRLQC_std=[], [], [], [], []
    #-------Initialization-------
